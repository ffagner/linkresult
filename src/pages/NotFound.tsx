...
export function NotFoundPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-4">
      ...
      <p className="mt-4 text-lg text-on-surface">Página não encontrada</p>
      <p className="mt-1 text-sm text-text-secondary">A página que você procura não existe ou foi movida.</p>
